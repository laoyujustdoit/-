...
public class ShixunbaogaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShixunbaogaoEntity shixunbaogao, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			shixunbaogao.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShixunbaogaoEntity shixunbaogao, HttpServletRequest request){
        EntityWrapper<ShixunbaogaoEntity> ew = new EntityWrapper<ShixunbaogaoEntity>();
		PageUtils page = shixunbaogaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shixunbaogao), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShixunbaogaoEntity> wrapper = new EntityWrapper<ShixunbaogaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shixunbaogaoService.selectCount(wrapper);
